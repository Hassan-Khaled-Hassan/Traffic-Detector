...
import useContactFunc from './useContactFunc';
...
const MyContact = ({ open, screenWidth }) => {
  // ==========================================
  const [Items, newItems, handleClick, loading] = useContactFunc();
  // =============================================
  const columns = [
    ...
    },
    {
      ...
      width: screenWidth > 600 ? "auto" : 300,
    },
    {
      field: "address",
      headerName: "Address",
    ...
    {
      field: "is_premium",
      headerName: "Is Premium",
      flex: screenWidth > 600 ? 0.55 : "auto",
      width: screenWidth > 600 ? "auto" : 150,
    },
    {
      field: "access",
