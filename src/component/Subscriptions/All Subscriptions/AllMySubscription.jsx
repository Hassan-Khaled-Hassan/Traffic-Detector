...
import useAllSubscribeHook from "./useAllSubscribeHook";
// eslint-disable-next-line react/prop-types
const AllMySubscription = ({ open, screenWidth, mode }) => {
  const [items] = useAllSubscribeHook();
  const columns = [
...
export default AllMySubscription;
