...
import AllUserSubscription from "../../component/Subscriptions/AllUserSubscriptions/AllUserSubscription";
import HeadersUA from "../../component/Utilities/HeadersU-A";

const AllSubscriptionsPage = ({ open, mode }) => {
  ...
  return (
    ...
    >
      <HeadersUA
        ...
        isbtn={false}
      />
      <AllUserSubscription open={open} screenWidth={screenWidth} mode={mode} />
    </Box>
  );
};
